...
var Package = function () {
  ...
  _createClass(Package, [{
    ...
    value: function hasMatchingDependency(dependency) {
      ...
      if (_semver2.default.valid(actualVersion) && _semver2.default.valid(expectedVersion)) {
      ...
      if (showWarning) {
        _logger2.default.warning("Version mismatch inside \"" + this.name + "\". " + ("Depends on \"" + dependency.name + "@" + expectedVersion + "\" ") + ("instead of \"" + dependency.name + "@" + actualVersion + "\"."));
      }
    ...
    value: function hasDependencyInstalled(dependency) {
      var packageJson = _path2.default.join(this.nodeModulesLocation, dependency, "package.json");
      try {
        return _semver2.default.satisfies(require(packageJson).version, this.allDependencies[dependency]);
      } catch (e) {
        return false;
      }
    }
    ...
    key: "allDependencies",
    get: function get() {
      return (0, _objectAssign2.default)({}, this.devDependencies, this.dependencies);
    }
  }, {
    key: "scripts",
    get: function get() {
